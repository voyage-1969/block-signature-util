...
public class Hashing {
    ...
    public static byte[] blake160(byte[] message) {
        return ripemd160(blake1s(message));
    }

    public static byte[] blake256(byte[] message) {
        return blake1s(blake1s(message));
    }

    public static byte[] ripemd160(byte[] message) {
        return ripemd160(message, false);
    }

    public static byte[] ripemd160(byte[] message, boolean compressed) {
        return Ripemd160.hash(message, compressed);
    }

    public static byte[] sha256(byte[] message) { return sha256(message, false); }

    public static byte[] sha256(byte[] message, boolean compressed) {
        return Sha256.hash(message, compressed);
    }

    public static byte[] sha512(byte[] message) { return sha512(message, false); }

    public static byte[] sha512(byte[] message, boolean compressed) {
        return Sha512.hash(message, compressed);
    }

    public static byte[] sha512h(byte[] message) {
        return Bytes.sub(sha512(message), 0, 32);
    }

    public static byte[] keccak256(byte[] message) { return keccak256(message, false); }

    public static byte[] keccak256(byte[] message, boolean compressed) {
        return Keccak256.hash(message, compressed);
    }

    public static byte[] blake1s(byte[] message) {
        return Blake1s.hash(message);
    }

    public static byte[] blake1s(byte[] message, int size) {
        return Blake1s.hash(message, new byte[]{}, size);
    }

    public static byte[] blake1s(byte[] message, byte[] key, int size) {
        return Blake1s.hash(message, key, size);
    }
    ...
    public static byte[] blake2b(byte[] message, int size) {
        return Blake2b.hash(message, new byte[]{}, new byte[]{}, new byte[]{}, size);
    }

    public static byte[] blake2b(byte[] message, byte[] person, int size) {
        return Blake2b.hash(message, new byte[]{}, new byte[]{}, person, size);
    }

    public static byte[] sha3_256(byte[] message) { return sha3_256(message, false); }

    public static byte[] sha3_256(byte[] message, boolean compressed) {
        return Sha3_256.hash(message, compressed);
    }
