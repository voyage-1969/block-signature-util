...
public class Nanowork {
    ...
    private static long blake2(long w0, long w1, long w2, long w3, long w4) {
        ...
        t0 += t4 + w0;
        tc = (((tc ^ t0) << 32) | ((tc ^ t0) >>> 32));
        t8 += tc;
        t4 = (((t4 ^ t8) << 40) | ((t4 ^ t8) >>> 24));
        t0 += t4 + w1;
        tc = (((tc ^ t0) << 48) | ((tc ^ t0) >>> 16));
        t8 += tc;
        t4 = (((t4 ^ t8) << 1) | ((t4 ^ t8) >>> 63));
        t1 += t5 + w2;
        td = (((td ^ t1) << 32) | ((td ^ t1) >>> 32));
        t9 += td;
        t5 = (((t5 ^ t9) << 40) | ((t5 ^ t9) >>> 24));
        t1 += t5 + w3;
        td = (((td ^ t1) << 48) | ((td ^ t1) >>> 16));
        t9 += td;
        t5 = (((t5 ^ t9) << 1) | ((t5 ^ t9) >>> 63));
        t2 += t6 + w4;
        te = (((te ^ t2) << 32) | ((te ^ t2) >>> 32));
        ta += te;
        t6 = (((t6 ^ ta) << 40) | ((t6 ^ ta) >>> 24));
        t2 += t6;
        te = (((te ^ t2) << 48) | ((te ^ t2) >>> 16));
        ta += te;
        t6 = (((t6 ^ ta) << 1) | ((t6 ^ ta) >>> 63));
        t3 += t7;
        tf = (((tf ^ t3) << 32) | ((tf ^ t3) >>> 32));
        tb += tf;
        t7 = (((t7 ^ tb) << 40) | ((t7 ^ tb) >>> 24));
        t3 += t7;
        tf = (((tf ^ t3) << 48) | ((tf ^ t3) >>> 16));
        tb += tf;
        t7 = (((t7 ^ tb) << 1) | ((t7 ^ tb) >>> 63));
        t0 += t5;
        tf = (((tf ^ t0) << 32) | ((tf ^ t0) >>> 32));
        ta += tf;
        t5 = (((t5 ^ ta) << 40) | ((t5 ^ ta) >>> 24));
        t0 += t5;
        tf = (((tf ^ t0) << 48) | ((tf ^ t0) >>> 16));
        ta += tf;
        t5 = (((t5 ^ ta) << 1) | ((t5 ^ ta) >>> 63));
        t1 += t6;
        tc = (((tc ^ t1) << 32) | ((tc ^ t1) >>> 32));
        tb += tc;
        t6 = (((t6 ^ tb) << 40) | ((t6 ^ tb) >>> 24));
        t1 += t6;
        tc = (((tc ^ t1) << 48) | ((tc ^ t1) >>> 16));
        tb += tc;
        t6 = (((t6 ^ tb) << 1) | ((t6 ^ tb) >>> 63));
        t2 += t7;
        td = (((td ^ t2) << 32) | ((td ^ t2) >>> 32));
        t8 += td;
        t7 = (((t7 ^ t8) << 40) | ((t7 ^ t8) >>> 24));
        t2 += t7;
        td = (((td ^ t2) << 48) | ((td ^ t2) >>> 16));
        t8 += td;
        t7 = (((t7 ^ t8) << 1) | ((t7 ^ t8) >>> 63));
        t3 += t4;
        te = (((te ^ t3) << 32) | ((te ^ t3) >>> 32));
        t9 += te;
        t4 = (((t4 ^ t9) << 40) | ((t4 ^ t9) >>> 24));
        t3 += t4;
        te = (((te ^ t3) << 48) | ((te ^ t3) >>> 16));
        t9 += te;
        t4 = (((t4 ^ t9) << 1) | ((t4 ^ t9) >>> 63));
        t0 += t4;
        tc = (((tc ^ t0) << 32) | ((tc ^ t0) >>> 32));
